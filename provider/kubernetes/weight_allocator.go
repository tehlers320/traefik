...
func newFractionalWeightAllocator(ingress *networkingv1.Ingress, client Client) (*fractionalWeightAllocator, error) {
...
func getServicesPercentageWeights(ingress *networkingv1.Ingress) (map[string]percentageValue, error) {
...
func getServiceInstanceCounts(ingress *networkingv1.Ingress, client Client) (map[ingressService]int, error) {
