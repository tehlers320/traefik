...
func (c *clientImpl) GetIngresses() []*networkingv1.Ingress {
...
func (c *clientImpl) UpdateIngressStatus(namespace, name, ip, hostname string) error {
	...
	ingCopy.Status = networkingv1.IngressStatus{LoadBalancer: corev1.LoadBalancerStatus{Ingress: []corev1.LoadBalancerIngress{{IP: ip, Hostname: hostname}}}}
